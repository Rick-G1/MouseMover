## [MouseMover](https://github.com/Rick-G1/MouseMover) Application for Arduino and Pro Micro (ATMega32U4)

Available as Arduino project "**MouseMover**"

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)

[![Hit Counter](https://hitcounter.pythonanywhere.com/count/tag.svg?url=https%3A%2F%2Fgithub.com%2FRick-G1%2FMouseMover)](https://github.com/brentvollebregt/hit-counter)
...
Commands are a single letter (to read) or a single letter followed by a number (to set value) and a <CR> or <CR><LF> as in  X<CR> or X20<CR> (can also be X=20)
